<ajax>
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header">
                <h1>Ajax get request</h1> <small>http://jsonplaceholder.typicode.com/posts</small>
            </div>
        </div>
    </div>
    <!-- progress -->
    <div class="row">
        <div class="col-sm-12 text-center" if="{ progress }"> <i class="fa fa-lg fa-cog fa-spin"></i> Loading posts... </div>
    </div>
    <!-- error -->
    ...
    <!-- results -->
    <div class="row" if="{ posts }" each="{ posts }">
        <div class="col-sm-12">
            <h3>{ title }</h3>
            <p>{ body }</p>
        </div>
